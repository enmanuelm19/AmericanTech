...
private Sesion sesionPostgres;
    ...
    public void agregarMotivoPostulacion(MotivoPostulacion dato) throws Exception{
    ...
    public void eliminarMotivoPostulacion(MotivoPostulacion dato) throws Exception{        
    	@SuppressWarnings("static-access")
		Session em = sesionPostgres.getSessionFactory().openSession();   
         Transaction tx = null;  
         try {    
    ...
    public void actualizarMotivoPostulacion(MotivoPostulacion dato) throws Exception{
        @SuppressWarnings("static-access")
        Session em = sesionPostgres.getSessionFactory().openSession();   
         Transaction tx = null;  
         try {    
    ...
    public List<MotivoPostulacion> obtenerTodos() throws Exception {            
           ...
           Session em = sesionPostgres.getSessionFactory().openSession();       
            try {   
            datos =  (List<MotivoPostulacion>) em.createCriteria(MotivoPostulacion.class).add(Restrictions.eq("activo", true)).list();             
            } catch (Exception e) {             
