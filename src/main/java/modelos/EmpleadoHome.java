...
public class EmpleadoHome {
	...
	public Empleado merge(Empleado detachedInstance) {
		...
		try {
			Empleado result = (Empleado) sessionFactory.getCurrentSession()
	...
	public Empleado findById(int id) {
		...
		try {
			Empleado instance = (Empleado) sessionFactory.getCurrentSession()
					.get("modelos.Empleado", id);
			if (instance == null) {
	...
	public List<Empleado> findByExample(Empleado instance) {
		...
		try {
			List<Empleado> results = (List<Empleado>) sessionFactory
					.getCurrentSession().createCriteria("modelos.Empleado")
