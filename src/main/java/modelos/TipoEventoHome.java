...
public class TipoEventoHome {
	...
	public TipoEvento merge(TipoEvento detachedInstance) {
		...
		try {
			TipoEvento result = (TipoEvento) sessionFactory.getCurrentSession()
	...
	public TipoEvento findById(int id) {
		...
		try {
			TipoEvento instance = (TipoEvento) sessionFactory
					.getCurrentSession().get("modelos.TipoEvento", id);
			if (instance == null) {
	...
	public List<TipoEvento> findByExample(TipoEvento instance) {
		...
		try {
			List<TipoEvento> results = (List<TipoEvento>) sessionFactory
					.getCurrentSession().createCriteria("modelos.TipoEvento")
