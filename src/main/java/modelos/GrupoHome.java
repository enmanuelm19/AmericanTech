...
public class GrupoHome {
	...
	public Grupo merge(Grupo detachedInstance) {
		...
		try {
			Grupo result = (Grupo) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Grupo findById(int id) {
		...
		try {
			Grupo instance = (Grupo) sessionFactory.getCurrentSession().get(
					"modelos.Grupo", id);
			if (instance == null) {
	...
	public List<Grupo> findByExample(Grupo instance) {
		...
		try {
			List<Grupo> results = (List<Grupo>) sessionFactory
					.getCurrentSession().createCriteria("modelos.Grupo")
