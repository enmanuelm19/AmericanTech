...
public class RecursoHome {
	...
	public Recurso merge(Recurso detachedInstance) {
		...
		try {
			Recurso result = (Recurso) sessionFactory.getCurrentSession()
	...
	public List<Recurso> findByExample(Recurso instance) {
		log.debug("finding Recurso instance by example");
		try {
			List<Recurso> results = (List<Recurso>) sessionFactory
					.getCurrentSession().createCriteria("modelos.Recurso")
