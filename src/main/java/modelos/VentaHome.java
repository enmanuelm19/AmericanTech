...
public class VentaHome {
	...
	public Venta findById(int id) {
		...
		try {
			Venta instance = (Venta) sessionFactory.getCurrentSession().get(
					"modelos.Venta", id);
			if (instance == null) {
	...
	public List<Venta> findByExample(Venta instance) {
		log.debug("finding Venta instance by example");
		try {
			List<Venta> results = (List<Venta>) sessionFactory
					.getCurrentSession().createCriteria("modelos.Venta")
