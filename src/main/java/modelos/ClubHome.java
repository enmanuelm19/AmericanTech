...
/**
 * Home object for domain model class Club.
 * @see modelos.Club
 * @author Hibernate Tools
 */
public class ClubHome {

	private static final Log log = LogFactory.getLog(ClubHome.class);
	...
	public void persist(Club transientInstance) {
		log.debug("persisting Club instance");
		try {
	...
	public Club merge(Club detachedInstance) {
		...
		try {
			Club result = (Club) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Club findById(int id) {
		...
		try {
			Club instance = (Club) sessionFactory.getCurrentSession().get(
					"modelos.Club", id);
			if (instance == null) {
	...
	public List<Club> findByExample(Club instance) {
		...
		try {
			List<Club> results = (List<Club>) sessionFactory
					.getCurrentSession().createCriteria("modelos.Club")
