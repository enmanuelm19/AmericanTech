...
insert into cliente_externo (nombre,apellido,correo,activo) values ('Jose','Altuve','elpequeÃƒÂ±ogigante@gmail.com',true);
...
insert into instalacion (nombre,descripcion,capacidad,precio_alquiler,alquilable,tipo_instalacionid_tipo_instalacion,activo) values ('Parque Infantil','area recreacional para niÃƒÂ±os',150,2000,false,3,true);
...
insert into eventualidad (instalacionid_instalacion,descripcion,fecha,personaid_persona,tipo_eventualidadid_tipo_eventualidad,activo) 
				  values (1,'Perdida de 3 sillas','01/02/2016',3,2,true),
				  		 (2, 'PartiÃ³ 3 sillas', '01-03-2016 09:00:00',5,5,TRUE),
	   			  		 (1, 'RiÃ±a con otro jugador', '04-03-2016 11:00:00',12,3,TRUE),
	   			  		 (3, 'Uso inadecuado de instalaciÃ³n', '05-03-2016 16:00:00',7,5,TRUE),
	   			 		 (3, 'CaminÃ³ desnudo dentro de la instalacion', '08-03-2016 18:00:00',6,4,TRUE),
	   			  		 (1, 'Hurto de pelota de Baseball', '11-03-2016 19:00:00',14,2,TRUE),
	   			 		 (2, 'RiÃ±a con otro socio', '16-03-2016 21:00:00',13,3,TRUE),
...
--actividad
insert into actividad (descripcion,finalizada,eventoid_evento,fecha_tope,fecha_realizacion,valor_esperado,valor_real,activo) values ('mantenimiento al campo de Beisbol',false,1,'10/03/2016','08/03/2016',2000,2200,true);
